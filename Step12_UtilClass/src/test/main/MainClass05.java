...
public class MainClass05 {
	public static void main(String[] args) {
		// 1. Member 객체를 담을 수 있는 ArrayList 객체를 생성해서 참조 값을 members라는 지역 변수에 담아 보세요.
		...
		Member mem3 = new Member(3, "원숭이", "방이동");
		
		// default 생성자를 호출해서 Member 객체를 생성하면
		...
		// 3. 위에서 생성된 Member 객체의 참조 값을 member List 객체에 모두 담아 보세요.
		members.add(mem1);
		members.add(mem1);
		members.add(mem3);
		members.add(mem4);
