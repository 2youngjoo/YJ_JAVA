...
public class Quiz01 extends JFrame implements ActionListener{
   //필드
   JTextField tf_num1, tf_num2;
   JLabel la2;
   
   //생성자
   public Quiz01(String title) {
      super(title);
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(strNum2.equals("0") || strNum2.equals("0.0")) {
    	  JOptionPane.showMessageDialog(this, "어떤 수를 0으로 나눌 수 는 없어요!");
    	  return;
      }
      ...
      try {
    	  ...
    	  JOptionPane.showMessageDialog(this, "숫자 형식으로 입력해 주세여!");
      }
   }
}
